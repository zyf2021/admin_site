		...
		<?php
			...
			switch ($act) {
				case 'home':
					...
					$num_rows = mysqli_num_rows($mysqli->query("SELECT * FROM documents WHERE direct = 'Устав города'")) or die('error! Записей не найдено!');
					$num_pages = ceil($num_rows / $per_page);
			
					$query = "SELECT id,name,theme,direct,content FROM documents WHERE direct = 'Устав города' LIMIT $start_page,$per_page";
